...
export const OLLAMA_MODEL_DROPDOWN_OPTIONS = [
  {
    ...
    tier: 'lite',
    description:
      'Официальная лёгкая модель от Яндекса. Идеальна для быстрого перевода на слабых компьютерах без GPU. Хорошо справляется с простыми игровыми текстами и описаниями на русском языке.',
  },
  {
    id: 'hf.co/IlyaGusev/saiga_yandexgpt_8b_gguf:Q8_0',
    title: 'Saiga YandexGPT 8B',
    badge: 'Рекомендуется',
    tags: ['Средняя', 'Качество', 'RU'],
    size: '~ 9 ГБ',
    vram: '10 ГБ VRAM',
    tier: 'newest',
    description:
      'Лучший выбор для перевода игрового контента EN→RU. Специально дообучена на русскоязычных текстах — высокое качество перевода диалогов, описаний предметов и способностей. Рекомендуется для большинства задач.',
  },
  {
    id: 'hf.co/IlyaGusev/saiga_gemma3_12b_gguf:Q8_0',
    title: 'Saiga Gemma3 12B',
    badge: 'Мощная',
    tags: ['Тяжёлая', 'Сильная', 'Новейшая', 'RU'],
    size: '~ 13 ГБ',
    vram: '16 ГБ VRAM',
    tier: 'rose',
    description:
      'Новейшая модель Saiga на базе Google Gemma 3. Превосходное качество русского языка с новейшей архитектурой трансформеров. Лучший выбор для профессионального качества переводов при наличии мощного GPU.',
  },
];
